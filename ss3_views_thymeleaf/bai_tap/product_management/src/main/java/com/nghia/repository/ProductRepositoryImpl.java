...
public class ProductRepositoryImpl implements IProductRepository {
    ...
    static {
        ...
        productMap.put(1, new Product(1, "mouse", 3000, "mouse", "dareU"));
        productMap.put(2, new Product(2, "keyboard", 4000, "keyboard", "logitech"));
        productMap.put(3, new Product(3, "light", 5000, "light", "logitech"));
    }
